...
namespace Sup20_12
{
    class DbConnection
    {
            ...
            using (var conn = new NpgsqlConnection(connectionString))
            {
                ...
                using (var command = new NpgsqlCommand(stmt, conn))
                {
                    ...
                    using (var reader = command.ExecuteReader())
                    {
                        while (reader.Read())
                        {
                            Highscore allHighscore = new Highscore(0, true, 0, 0)
                            {
                                Id = (int)reader["id"],
                                Win = (bool)reader["win"],
        ...
        //public static IEnumerable<Highscore> GetActivePlayerHighscore(int id) //Byt private mot public när denna funktion är klar
        //{
        ...
        //    {
        //        //Highscore myHighscore = null;
        //        List<Highscore> LstActivePlayerHighscore = new List<Highscore>();
        //        conn.Open();
        ...
        //                while (reader.Read())
        //                {
        //                    Highscore myHighscore = new Highscore(0, true, 0,0)
        //                    {
        //                        Id = (int)reader["id"],
        //                        Win = (int)reader["win"],
        //                        Date = (DateTime)reader["date"],
        ...
        //                        PlayerId = (int)reader["player_id"]
        //                    };
        //                    LstActivePlayerHighscore.Add(myHighscore);
        //                }
        //            }
        //        }
        //        return LstActivePlayerHighscore;
        //    }
